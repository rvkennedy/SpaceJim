...
autoresizesSurface=_autoresize,
surfaceSize=_size,
framebuffer = _framebuffer,
pixelFormat = _format,
depthFormat = _depthFormat,
multipleTouchEnabled = _multipleTouchEnabled,
context = _context;
...
- (void)touchesEnded:(NSSet*)touches withEvent:(UIEvent*)event
{
	...
	[(CrashLandingAppDelegate*)[[UIApplication sharedApplication] delegate] handleTap];
	//UITouch *touch = [touches anyObject];
	for(int i=0;i<[touches count];i++)
	{
	/*	UITouch *touch= [touches allObjects[i]];
